...
class ChooseTag extends StatelessWidget {
  ...
  List<Map> getTagsUnlocked() {
    return tags.where((element) => element['isLocked'] == false).toList();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Tooltip(
      ...
      decoration: const ShapeDecoration(
        ...
        shape: TooltipCustom(),
        shadows: [
          BoxShadow(color: Color(0x400066FF), blurRadius: SpacingUnit.x3)
        ],
      ),
      textStyle: const TextStyle(
          color: Color(0xFF6D70A0),
        ...
        OutlinedButton(
            ...
            child: Text(tags[index]["title"],
                ...
                style: TextStyle(
                    ...
                    color: colors.surfaceDim.withOpacity(0.5)))),
        Container(
